    ...
    class PlantDiscovery
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (Plant.NonExistingPlant(plantJournal, plantName))
                {
        ...
        class Plant
        {
            ...
            public static bool NonExistingPlant(List<Plant> testJournal, string plantName) 
            {
                if (testJournal.Where(x => x.Name == plantName).ToList().Count == 0)
                {
                    return true;
                }
